...
public class DeleteLocation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Location deletedLocation = locationService.deleteLocation(Integer.parseInt(idLocation));
        
        HttpSession mySession = request.getSession(true);
        mySession.setAttribute("deletedLocation",deletedLocation);
        
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/deleteLocation_jstl.jsp");
