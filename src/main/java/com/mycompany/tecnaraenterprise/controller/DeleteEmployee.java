...
public class DeleteEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Employee resultado = employeeService.deleteEmployee(Integer.parseInt(idEmployee));
        
        HttpSession mySession = request.getSession(true);
        mySession.setAttribute("resultado",resultado);
        
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/deleteEmployee.jsp");
